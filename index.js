...
function heros(hero , power, city){
return hero + " uses " + power + " to protect " + city + ".";
};


// Step 4: Call the function below for Spider-Man, Magneto, & Wonder Woman
console.log(heros("Spider-Man" , "Web-Slinging" , "NYC"));
console.log(heros("Magneto", "Magnetic-Field-Manipulation", "Genosha"));
console.log(heros("Wonder-Woman", "Super Strength", "Themyscira"));
// 2. Classwork

// Task 1: Add more superheroes!
// Create at least two more superheroes by calling your function for each one.
console.log(heros("Batman" , "Weapons" , "Gotham"));
console.log(heros("Superman" , "Super-Human" , "Metropolis"));
...
function sinisterSix(villian , location , choas){
return villian + " has escaped from the Raft and is causing chaos in " + location + " by " + choas + " !";
};
...
console.log(sinisterSix("Doctor Octopus", "Times Square", "destroying cars with his mechanical arms"));
console.log(sinisterSix("Electro" , "Central Park", "overloading the city's power grid"));
console.log(sinisterSix("Vulture" , "Empire State Building", "swooping down and grabbing people off the streets"));
console.log(sinisterSix("Sandman" , "Brooklyn Bridge", "turning the bridge into sand"));
console.log(sinisterSix("Mysterio" , "Broadway" , "casting illusions to confuse and panic everyone"));
...
console.log(sinisterSix("Kraven The Hunter" , "Bronx Zoo" , "releasing and hunting wild animals"));
...
console.log(hero("Tony Stark" , "NYC", "Avengers", "Mandarin", "I am Iron Man"));
